...
namespace NWH.VehiclePhysics2.Effects
{
    ...
    public class SurfaceParticleSystem
    {
        ...
        /// </summary>
        [UnityEngine.Tooltip("Coefficient by which the lateral slip will be multiplied.\r\nIncrease the value to emit more particles when there is lateral slip (wheel skid / drift).")]
        ...
        /// </summary>
        [UnityEngine.Tooltip("Coefficient by which the longitudinal slip will be multiplied.\r\nIncrease the value to emit more particles when there is longitudinal slip (wheel spin).")]
        public float longitudinalSlipCoeff = 0.5f;
        
        /// <summary>
        /// Coefficient by which the particle start size will be multiplied.
        /// </summary>
        [UnityEngine.Tooltip("Coefficient by which the particle start size will be multiplied.")]
        public float particleSizeCoeff = 1f;
        
        /// <summary>
        /// Coefficient by which the emission rate will be multiplied.
        /// </summary>
        [UnityEngine.Tooltip("Coefficient by which the emission rate will be multiplied.")]
        public float emissionRateCoeff = 1f;
        
        /// <summary>
        /// Current particle count in the scene.
        /// </summary>
        [UnityEngine.Tooltip("Current particle count in the scene.")]
        public int particleCount;
        
        /// <summary>
        /// Makes the particle either emit or not emit with no in-between.
        /// </summary>
        [UnityEngine.Tooltip("Makes the particle either emit or not emit with no in-between.")]
        ...
        private void UpdateParticles()
        {
            ...
            if (surfacePreset.particleType == SurfacePreset.ParticleType.Smoke)
            {
                ...
                else
                {
                    ...
                    newSmokeEmissionRate = Mathf.Clamp01(latEmission + lngEmission) * surfacePreset.maxParticleEmissionRateOverDistance;
