...
namespace NWH.VehiclePhysics2.Effects
{
    ...
    public class SurfaceParticleManager : Effect
    {
        ...
        /// </summary>
        [UnityEngine.Tooltip("When enabled the particle system will either emit or not emit, with no in-between. Also removes any smoothing.")]
        public bool binaryEmission = false;
