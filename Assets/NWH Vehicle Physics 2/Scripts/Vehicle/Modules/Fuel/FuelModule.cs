...
namespace NWH.VehiclePhysics2.Modules.Fuel
{
    ...
    public class FuelModule : VehicleModule
    {
        ...
        {
            get => UnitConverter.L100kmToKml(consumptionLPer100km);
        }
        ...
        {
            get => UnitConverter.L100kmToMpg(consumptionLPer100km);
        }
        ...
        {
            get => Mathf.Clamp01(amount / capacity);
        }
