...
namespace NWH.VehiclePhysics2
{
    ...
    public class VehicleControllerInspector : NVP_NUIEditor
    {
        ...
        private void DrawSettingsTab()
        {
            ...
            drawer.Info(
                "Freeze When Asleep and Constrain When Asleep will be disabled when a trailer is attached as these options do not work" +
                " with physics joints.");
            drawer.EndSubsection();
