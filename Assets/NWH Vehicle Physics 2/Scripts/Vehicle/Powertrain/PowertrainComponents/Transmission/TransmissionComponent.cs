...
namespace NWH.VehiclePhysics2.Powertrain
{
    ...
    public class TransmissionComponent : PowertrainComponent
    {
        ...
        /// </summary>
        [UnityEngine.Tooltip("If true the gear input has to be held for the transmission to stay in gear, otherwise it goes to neutral.\r\nUsed for hardware H-shifters.")]
        ...
        /// </summary>
        [Range(0, 4)]
        [UnityEngine.Tooltip("How much inclines affect shift point position. Higher value will push the shift up and shift down RPM up depending\r\non the current incline to prevent vehicle from upshifting at the wrong time.")]
        ...
        /// </summary>
        [SerializeField]
        [UnityEngine.Tooltip("Event that gets triggered when transmission shifts down.")]
        ...
        /// </summary>
        [SerializeField]
        [UnityEngine.Tooltip("Event that gets triggered when transmission shifts (up or down).")]
        ...
        /// </summary>
        [SerializeField]
        [UnityEngine.Tooltip("Event that gets triggered when transmission shifts up.")]
        ...
        [UnityEngine.Tooltip("Behavior when switching from neutral to forward or reverse gear.")]
        public AutomaticTransmissionReverseType automaticTransmissionReverseType = AutomaticTransmissionReverseType.Auto;
        ...
        /// </summary>
        [HideInInspector]
        [UnityEngine.Tooltip("List of shift checks that all have to return true before the vehicle can shift.")]
        public List<ShiftCheck> shiftChecks = new List<ShiftCheck>();
        
        /// <summary>
        /// True when all shift conditions are fulfilled.
        /// </summary>
        [UnityEngine.Tooltip("True when all shift conditions are fulfilled.")]
        ...
        /// </summary>
        [UnityEngine.Tooltip("Function that changes the gears as required.\r\nUse transmissionType External and assign this delegate to use your own gear shift code.")]
        ...
        /// </summary>
        [Range(0, 1)]
        [UnityEngine.Tooltip("Intensity of variable shift point. Higher value will result in shift point moving higher up with higher engine load.")]
        ...
        /// </summary>
        [UnityEngine.Tooltip("If enabled shifting when in manual transmission will be instant, ignoring post shift ban.")]
        ...
        private bool _repeatInputFlag = false;
        ...
        {
            get => UnitConverter.RPMToAngularVelocity(_downshiftRPM);
        }
        ...
        {
            get => _ratio < 0.0001f && _ratio > -0.0001f;
        }
        ...
        {
            get => gearRatios.Count - 1 - gearingProfile.reverseGears.Count;
        }
        ...
        {
            get => gearingProfile.forwardGears;
            set
            {
        ...
        {
            get => gearingProfile.reverseGears.Count;
        }
        ...
        {
            get => gearingProfile.reverseGears;
            set
            {
        ...
        {
            get => UnitConverter.RPMToAngularVelocity(_upshiftRPM);
        }
        ...
        public void ShiftInto(int g, bool instant = false)
        {
            ...
            if (instant || (externalShiftChecksValid && !postShiftBanActive))
            {
                ...
                _lastGearShift.RegisterShift(Time.realtimeSinceStartup, shiftDuration, g, prevGear);
        ...
        private void AutomaticShift(VehicleController vc, bool shiftChecksValid)
        {
            ...
            _smoothedYAxis01 = Mathf.SmoothDamp(_smoothedYAxis01, throttleInput, ref _verticalInputChangeVelocity, damping);
        ...
        private void CVTShift(VehicleController vc, bool shiftChecksValid)
        {
            ...
            _totalReceivedTorque = _totalReceivedTorque * Time.fixedDeltaTime;
            float torqueFactor = (_totalReceivedTorque < 0 ? -_totalReceivedTorque : _totalReceivedTorque) /
                                 cvtMaxInputTorque;
