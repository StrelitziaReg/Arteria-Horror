...
namespace NWH.VehiclePhysics2.Powertrain
{
    ...
    public class WheelComponent : PowertrainComponent
    {
        ...
        {
            get => wheelController.brakeTorque;
        ...
        {
            get => wheelController.gameObject;
        }
        ...
        {
            get => wheelController.cachedTransform;
        }
        ...
        {
            get => NormalizedLateralSlip > vc.lateralSlipThreshold;
        }
        ...
        {
            get => NormalizedLongitudinalSlip > vc.longitudinalSlipThreshold;
        }
        ...
        {
            get => wheelController.isGrounded;
        }

        public float LateralSlip
        {
            get => wheelController.sideFriction.slip;
        }
        ...
        {
            get => wheelController.forwardFriction.slip;
        }
        ...
        {
            get => wheelController.motorTorque;
        ...
        {
            get => wheelController.springCompression * wheelController.springLength;
        }
        ...
        {
            get => wheelController.steerAngle;
