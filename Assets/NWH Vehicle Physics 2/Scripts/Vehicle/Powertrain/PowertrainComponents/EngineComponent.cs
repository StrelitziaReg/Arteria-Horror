...
namespace NWH.VehiclePhysics2.Powertrain
{
    ...
    public partial class EngineComponent : PowertrainComponent
    {
        ...
        {
            get => UnitConverter.RPMToAngularVelocity(idleRPM);
        }
        ...
        {
            get => ignition && angularVelocity > _stallAngularVelocity;
        }
        ...
        {
            get => UnitConverter.RPMToAngularVelocity(maxRPM);
        }
        ...
        {
            get => UnitConverter.RPMToAngularVelocity(minRPM);
        }
        ...
        {
            get => UnitConverter.RPMToAngularVelocity(revLimiterRPM);
        }
        ...
        {
            get => UnitConverter.RPMToAngularVelocity(stallRPM);
        }
        ...
        {
            get => UnitConverter.RPMToAngularVelocity(starterRPMLimit);
        }
