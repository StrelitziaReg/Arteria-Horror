...
namespace NWH.WheelController3D
{
    ...
    public class WheelController : MonoBehaviour
    {
        ...
        {
            get => cachedTransform.InverseTransformPoint(worldCenter);
        }
        ...
        {
            get => longitudinalScanResolution;
            set
            {
        ...
        {
            get => parentRigidbody.GetPointVelocity(wheel.worldPosition);
        }
        ...
        {
            get => 1f - spring.compressionPercent;
        }
        ...
        {
            get => cachedTransform.position - cachedTransform.up * spring.length;
        }
        ...
        {
            get => _transformPosition - _transformUp * spring.length;
        }
        ...
        private void Reset()
        {
            ...
            if (parentRigidbody.mass > 1.1f)
            {
                ...
                maximumTireLoad = weightPerWheel * 2f;
                maximumTireGripForce = weightPerWheel * 2.2f;
                spring.length = wheel.radius * 1.2f;
            }
        }
